...
public class RabbitDestinationBinderConfiguration<T> {
	...
	@Bean("rabbit")
	public DestinationBinder<? extends ConsumerProperties, ? extends ProducerProperties> destinationRabbitBinder(RabbitExchangeQueueProvisioner provisioner,
			RabbitExtendedBindingProperties extendedBindingProperties, ConnectionFactory connectionFactory, FunctionCatalog functionCatalog, FunctionInspector functionInspector,
			@Nullable CompositeMessageConverterFactory converterFactory) {
		return (DestinationBinder<? extends ConsumerProperties, ? extends ProducerProperties>)
				new RabbitDestinationMessageBinder<>(functionCatalog, functionInspector, provisioner, extendedBindingProperties, connectionFactory, converterFactory);
	}
